...
class PIBITI:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PIBITI', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/PIBITI/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        # funções criadas
        self.dlg.pushButton.clicked.connect(self.rodaLink)
